...
public class Cat implements Jumpable, Runnable, Competitional {
    ...
    @Override
    public void jump() {
        System.out.printf("Cat %s is jumping; jumpability is %s.\n", name, jumpability);
    }

    @Override
    public void run() {
        System.out.printf("Cat %s is running; runability is %s.\n", name, runability);
    }
